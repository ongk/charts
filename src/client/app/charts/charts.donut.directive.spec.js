describe('donut chart directive', function() {

  var scope, element;

  beforeEach(module('hz.app.charts'));
  ...
  beforeEach(inject(function($compile, $rootScope) {
      ...
      element = angular.element('<donut-chart chart-data="testData"></donut-chart>');
  ...
  it('should have 3 path elements', function() {
    expect(element[0].querySelectorAll('path.arc').length).toBe(3);
  });

  it('should have correct path HTML', function() {
    var arcs = element[0].querySelector('g.arcs');
    var arcsHtml = '<path style="fill: rgb(31, 131, 198);" title="Current: 1" class="arc" ' +
      ...
      '<path style="fill: rgb(129, 193, 231);" title="Applied: 1" class="arc" ' +
      ...
      'title="Available: 6" class="arc" d="M35,0A35,35 0 1,1 -6.429395695523604e-15,-35' +
